...
*/        
    ...
    var processMessage = (function (message) {
    	...
    	if(message.senderSessionId !== null && message.receiverSessionId != null && message.senderSessionId != message.receiverSessionId){
...
uploadImage = function () {
	...
	if(receiverSessionId == null || !establishedSession){
